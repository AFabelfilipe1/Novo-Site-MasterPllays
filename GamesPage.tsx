...
export default function GamesPage() {
  ...
  const videosQuery = trpc.videos.list.useQuery({ category: "games" });
          ...
          <div className="max-w-6xl mx-auto">
            <div className="mb-8">
              ...
              <p className="text-xl text-foreground/60 max-w-2xl">
                Descubra os melhores gameplays, speedruns e momentos épicos dos seus games favoritos.
              </p>
            </div>
            ...
            {videosQuery.isLoading ? (
              <div className="flex items-center justify-center py-20">
                <div className="text-center">
                  ...
                  <p className="text-foreground/60">Carregando gameplays...</p>
                </div>
              </div>
                  ...
                  <Link key={video.id} href={`/watch/${video.id}`}>
                    <Card className="backdrop-blur-xl bg-white/10 border-white/20 overflow-hidden hover:border-primary/50 hover:bg-white/15 transition-all group cursor-pointer h-full">
                      ...
                      <div className="relative overflow-hidden aspect-video bg-black/40">
                        <img
                          src={video.thumbnail || "https://images.unsplash.com/photo-1538481143235-5d630a6a4b1b?w=500&h=280&fit=crop"}
                          alt={video.title}
                      ...
                      <div className="p-4 space-y-3">
                        ...
                        <p className="text-sm text-foreground/60 line-clamp-2">
                          {video.description || "Confira este incrível gameplay"}
                        </p>
              ...
              <div className="text-center py-20">
                <p className="text-foreground/60 text-lg mb-4">
                  {searchQuery ? "Nenhum gameplay encontrado com essa busca" : "Nenhum gameplay disponível no momento"}
                </p>
                {searchQuery && (
                  <Button
